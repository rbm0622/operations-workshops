...
+
----
$ cf login -u <username> -a https://api.cfns.customer.net --skip-ssl-validation
----
+
Follow the prompts.
...
+
----
$ cd <dir>/cf-spring-mvc-boot
* where <dir> is the directory you unzipped the app.
----
...
. Start the deployed application using the CLI
+
----
$ cf start <<app_name>>
----
